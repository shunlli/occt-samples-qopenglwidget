/**
* \file Sketcher_CommandCircleP2Tan.cxx
* \brief Implementation file for the class Sketcher_CommandCircleP2Tan
* \author <a href="mailto:sergmaslov@istel.ru?subject=Sketcher_CommandCircleP2Tan.cxx">Sergei Maslov</a>
*/
 ...
 */
Standard_Boolean Sketcher_CommandCircleP2Tan::MouseInputEvent(const gp_Pnt2d& thePnt2d, bool ortho)
{
 ...
 * \param thePnt2d const gp_Pnt2d&
 */
void Sketcher_CommandCircleP2Tan::MouseMoveEvent(const gp_Pnt2d& thePnt2d, bool ortho)
{
...
void Sketcher_CommandCircleP2Tan::CancelEvent()
{
 switch (myCircleP2TanAction)
 {
	...
	case Input_2CircleTan: 	myContext->Remove(myRubberLine, true);
							break;
	case Input_3CircleTan: 	myContext->Remove(myRubberLine, false);
							myContext->Remove(myRubberCircle, true);
							break;
	default: break;
 }
 gp_linExist = Standard_False;
