 ...
 */
Standard_Boolean Sketcher_CommandCircleCenterRadius::MouseInputEvent(const gp_Pnt2d& thePnt2d, bool ortho)
{
 ...
 * \param thePnt2d const gp_Pnt2d&
 */
void Sketcher_CommandCircleCenterRadius::MouseMoveEvent(const gp_Pnt2d& thePnt2d, bool ortho)
{
 switch (myCircleCenterRadiusAction)
 {
	case Nothing:break;
