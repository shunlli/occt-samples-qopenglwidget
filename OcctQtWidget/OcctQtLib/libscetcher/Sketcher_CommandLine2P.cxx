    ...
    : Sketcher_Command("Line2P.")
{
    ...
    std::cout<<"new command line2P"<<std::endl;
}
 ...
 */
Standard_Boolean Sketcher_CommandLine2P::MouseInputEvent(const gp_Pnt2d& thePnt2d, bool ortho)
{
    ...
    case Input_SecondPointLine:
    {
        ...
        if(ortho){
            double x=sqrt(pow(myFirstgp_Pnt2d.X()-curPnt2d.X(),2));
            double y=sqrt(pow(myFirstgp_Pnt2d.Y()-curPnt2d.Y(),2));
            if(x>=y){
                curPnt2d.SetY(myFirstgp_Pnt2d.Y());
            } else {
                curPnt2d.SetX(myFirstgp_Pnt2d.X());
            }
        }
 ...
 * \param thePnt2d const gp_Pnt2d&
 */
void Sketcher_CommandLine2P::MouseMoveEvent(const gp_Pnt2d& thePnt2d, bool ortho)
{
