...
public:
    arccenter();
    //! Give 3 circumfence arc or circle points, the calculated result is the 3d centerpoint, radius, arc_angle.
    void circlecenter3d(gp_Pnt p1, gp_Pnt p2, gp_Pnt p3, gp_Pnt &cp, double &radius, double &arc_angle);
};
